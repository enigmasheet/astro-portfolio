...
Blazor WebAssembly lets you build rich, interactive web UIs using C# instead of JavaScript. Here's what I learned building an earlier, Blazor WebAssembly version of my portfolio. That version has since been replaced by the current Astro site, but the lessons still hold.
